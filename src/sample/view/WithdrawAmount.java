...
public class WithdrawAmount {
    @FXML
    private TextField readBal;

    @FXML
    private Label withdrawField;
    String currentuser = "";
    ...
    @FXML
    public void onBtnWithdraw(ActionEvent ae) throws IOException {
        ...
        String addamount=readBal.getText();
        if(Integer.parseInt(addamount)<=0)
            withdrawField.setText("   Invalid Amount !!!");
        else
        {
            if(Integer.parseInt(addamount)<=Integer.parseInt(mybal))
            {
            ...
            {
                withdrawField.setText("Insufficient Balance !!!");
            }
        }
